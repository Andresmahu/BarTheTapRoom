...
public class DataArticulo {
    ...
    public String EliminarArticulo(){
        ...
        String cad= "delete from articulo where art_cod='" 
                + this.getArt_cod()+"'";
    ...
    public String EditarArticulo(){
        ...
        String cad="update articulo set art_nom='" 
                + this.getArt_nom() + "', art_uni='" 
                + this.getArt_uni() + "', art_pre='" 
                + this.getArt_pre() + "', art_stk='" 
                + this.getArt_stk() + "', art_marca='" 
                + this.getArt_marca() + "'where art_cod='" 
                + this.getArt_cod() + "'";
        return objmod.Ejecutar(cad);
    }
    public ArrayList<DataArticulo> ListaArticulos(){
        ...
        DataArticulo objart;
            while (tabla.next()){
                ...
                objart.setArt_pre(Double.parseDouble(tabla.getString("art_pre")));
                objart.setArt_stk(Integer.parseInt(tabla.getString("art_stk")));
                objart.setArt_marca(tabla.getString("art_cod"));
                lista2.add(objart);
            }
        }
